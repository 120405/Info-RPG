...
public class FightAnimator implements ApplicationListener {
    ...
    public void createAnimationMaps() {
        heroAnim.put("Attack1",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Hero/Attack"+ 1+".png")), 1, 5, 0.2f, 0));
        heroAnim.put("Attack2",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Hero/Attack"+ 2+".png")), 1, 4, 0.2f, 0));
        heroAnim.put("Attack3",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Hero/Attack"+ 3+".png")), 1, 4, 0.2f, 0));
        ...
        monsters.get(1).put("Attack1",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Monster1/Attack"+ 1 +".png")), 1, 5, 0.2f, 0));
        monsters.get(1).put("Attack2",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Monster1/Attack"+ 2 +".png")), 1, 4, 0.2f, 0));
        monsters.get(1).put("Attack3",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Monster1/Attack"+ 3 +".png")), 1, 4, 0.2f, 0));
        ...
        monsters.get(2).put("Attack1",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Monster2/Attack"+ 1 +".png")), 1, 4, 0.2f, 0));
        monsters.get(2).put("Attack2",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Monster2/Attack"+ 2 +".png")), 1, 4, 0.2f, 0));
        monsters.get(2).put("Attack3",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Monster2/Attack"+ 3 +".png")), 1, 5, 0.2f, 0));
        ...
        monsters.get(3).put("Attack1",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Monster3/Attack"+ 1+".png")), 1, 5, 0.2f, 0));
        monsters.get(3).put("Attack2",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Monster3/Attack"+ 2+".png")), 1, 6, 0.2f, 0));
        monsters.get(3).put("Attack3",createAnimRow(new Texture(Gdx.files.internal("FightAnimations/Monster3/Attack"+ 3+".png")), 1, 4, 0.2f, 0));
    ...
    public void render() {
        ...
        if(!currentHeroAnim.equals("Dead")) {
            if (heroAnim.get(currentHeroAnim).isAnimationFinished(stateTimeHero)) {
                ...
                if (currentHeroAnim.equals("Attack1") ||currentHeroAnim.equals("Attack2") ||currentHeroAnim.equals("Attack3")) {
                    currentHeroAnim = "Idle";
                    if(!currentMonsterAnim.equals("Dead")) {
                        if(Spiel.INSTANCE.getFightScreen().getMonsterDMG()) {
                            ...
                            currentMonsterAnim = "Attack" + MathUtils.random(1,3);
                            stateTimeMonster = 0f;
                        }
        ...
        if(!currentMonsterAnim.equals("Dead")) {
            if(monsters.get(monsterType).get(currentMonsterAnim).isAnimationFinished(stateTimeMonster)) {
                ...
                if(currentMonsterAnim.equals("Hurt")) {
                    currentMonsterAnim = "Attack" + MathUtils.random(1,3);
                } else if(currentMonsterAnim.equals("Attack1") || currentMonsterAnim.equals("Attack2") || currentMonsterAnim.equals("Attack3")) {
                    currentMonsterAnim = "Idle";
        ...
        if(currentMonsterAnim == "Dead") {
            if(currentHeroAnim != "Attack1" || currentHeroAnim != "Attack2" || currentHeroAnim != "Attack3") {
