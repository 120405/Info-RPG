 ...
 * anschlieﬂend SQL-Anweisungen an diese Datenbank gerichtet werden koennen.
 * </p>
 * 
...
public class DatabaseConnector{
   ...
   * liefert, so kann dieses Ergebnis anschlieﬂend mit der Methode getCurrentQueryResult 
   * abgerufen werden.
   */
  public void executeStatement(String pSQLStatement){  
    ...
    try {
      ...
      if (statement.execute(pSQLStatement)) { //Fall 1: Es gibt ein Ergebnis
        ...
        //Statement schlieﬂen und Ergebnisobjekt erstellen
        statement.close();
